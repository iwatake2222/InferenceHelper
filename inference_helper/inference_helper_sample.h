...
==============================================================================*/
#ifndef INFERENCE_HELPER_SAMPLE_
#define INFERENCE_HELPER_SAMPLE_
...
class InferenceHelperSample : public InferenceHelper {
public:
    InferenceHelperSample();
    ~InferenceHelperSample() override;
