...
==============================================================================*/
#ifndef INFERENCE_HELPER_TENSORFLOW_
#define INFERENCE_HELPER_TENSORFLOW_
...
class InferenceHelperTensorflow : public InferenceHelper {
public:
    InferenceHelperTensorflow();
    ~InferenceHelperTensorflow() override;
...
private:
    ...
    TF_Session* session_;
    TF_Graph* graph_;
    std::vector<TF_Output> input_op_list_;
    std::vector<TF_Output> output_op_list_;
    std::vector<TF_Tensor*> input_tensor_list_;
    std::vector<TF_Tensor*> output_tensor_list_;
};
